...
<a id="chapter-0"></a>
## Описание проекта
Ультразвуковой дальномер с дисплеем
- Используется дисплей на драйвере TM74HC595
- Показания с дальномера фильтруются, благодаря чему достигнута точность ~1 мм
- Отдельный переключатель позволяет сдвигать начало отсчёта на противоположный конец корпуса
- Подробности в видео: https://youtu.be/68Vz_fjo42I
